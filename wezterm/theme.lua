...
-- local color_scheme = "Porple (base16)"
-- local color_scheme = "Rebecca (base16)"
-- local color_scheme = "Twilight (base16)"
-- local color_scheme = "Black Metal (base16)"
-- local color_scheme = "Brewer (base16)"
-- local color_scheme = "Harmonic16 Dark (base16)"
-- local color_scheme = "Classic Dark (base16)"
...
return {
	...
	tab_bar_color_scheme = tab_bar_color_scheme,
	blur = blur,
}
