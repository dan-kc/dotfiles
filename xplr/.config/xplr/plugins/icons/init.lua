...
function setup()
	...
	xplr.config.node_types.special["Templates"] = { meta = { icon = "陼" } }
	...
	xplr.config.node_types.extension.rmd = { meta = { icon = "" } }
	xplr.config.node_types.extension.rproj = { meta = { icon = "鉶" } }
	...
	xplr.config.node_types.extension.xml = { meta = { icon = "謹" } }
