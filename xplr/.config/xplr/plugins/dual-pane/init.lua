...
local function split_pane(layout, left_pane_width, right_pane_width, left_pane, right_pane)
	...
	elseif layout.Horizontal or layout.Vertical then
		...
		for _, v in pairs(res) do
			for i, l in ipairs(v.splits) do
				v.splits[i] = split_pane(l, left_pane_width, right_pane_width, left_pane, right_pane)
			end
		end
		return res
	else
...
local function setup(args)
	...
	xplr.config.layouts.custom.left_pane_active =
		split_pane(default_layout, args.active_pane_width, args.inactive_pane_width, "Table", inactive_pane_layout)

	xplr.config.layouts.custom.right_pane_active =
		split_pane(default_layout, args.inactive_pane_width, args.active_pane_width, inactive_pane_layout, "Table")
